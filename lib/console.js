...
class ConsoleView extends atomSpacePenViews.View {
  ...
  destroy() {
    ...
    (_this$disposables = this.disposables) === null || _this$disposables === void 0 ? void 0 : _this$disposables.dispose();
  }
...
var console = {
  ...
  deactivate() {
    ...
    (_this$subscriptions = this.subscriptions) === null || _this$subscriptions === void 0 ? void 0 : _this$subscriptions.dispose();
    (_this$consoleView = this.consoleView) === null || _this$consoleView === void 0 ? void 0 : _this$consoleView.destroy();
  },
